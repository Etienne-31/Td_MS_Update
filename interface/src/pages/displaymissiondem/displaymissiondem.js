...
function Displaymissiondem() {
    ...
    const handleAcceptMission = () => {
        ...
        window.location.href = '/demmodify';
    };
        ...
        <div className="container">
            ...
            {mission && (
                <div className="mission-info">
                    ...
                    <button className="accept-button" onClick={handleAcceptMission}>Modifier la mission</button>
...
export default Displaymissiondem;