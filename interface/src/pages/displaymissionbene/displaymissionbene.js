...
function Displaymissionbene() {
    ...
    const handleReturn = () => {
        ...
        if (confirmLogout) {
            ...
            window.location.href = '/menubene'; // Redirigez vers la page d'accueil
        }
    };
    ...
    const handleAcceptMission = () => {
        ...
        localStorage.setItem('intituleMission', mission.intituleMission);
        // Redirect to another page or show confirmation
        window.location.href = '/beneaccept'; // Redirigez vers la page d'accueil
    };
        ...
        <div className="container">
            ...
            {mission && (
                <div className="mission-info">
                    ...
                    <button className="accept-button" onClick={handleAcceptMission}>Accepter la mission</button>
...
export default Displaymissionbene;